...
export class MockedRequest {
  ...
  matchParams(params) {
    ...
    const emptyMockParams = this.params === undefined || this.params === null;
    const emptyRequestParams = params === undefined || params === null;
  ...
  export() {
    ...
    if (mock.headers['content-type'].indexOf('application/json') > -1) {
      try {
