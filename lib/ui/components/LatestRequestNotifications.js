    ...
    return (
      <Container fadingOut={ this.state.fadingOut }
        ...
        <Control onClick={ this.onEdit }>
          {
            mock && mock.active &&
            <Icon style={{ marginRight: 6 }} src="mocked" alt="Mocked Request"/>
          }

          {
            mock && !mock.active &&
            <Icon style={{ marginRight: 6 }} src="unmocked" alt="Unocked Request"/>
          }
...

          {
            ...
            <Icon src="spin" alt="Pending Request"/>
          }
          <Icon src="edit" alt="Mock Response"/>
        </Control>
      </Container>
    );
  }
