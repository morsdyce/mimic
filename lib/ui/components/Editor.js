  ...
  render() {
    ...
    return (
      <Container>
        ...
        <Tabs options={ ['request body', 'response headers', 'response body'] }
              selectTab={ this.selectResponseContentTab }
              selectedTab={ this.state.selectedResponseContentTab }/>

        {
          this.state.selectedResponseContentTab === 'request body' && (
            <CodeEditor
              key={ `${selectedMock.id}` }
              value={ value }
              onChange={ this.handleCodeEditorChange }
              contentType={ get(selectedMock, 'params') }/>
          )
        }

        {
          this.state.selectedResponseContentTab === 'response body' && (
            <CodeEditor
              key={ `${selectedMock.id}` }
              value={ value }
              onChange={ this.handleCodeEditorChange }
        ...
        {
          this.state.selectedResponseContentTab === 'response headers' && (
            <div>
              {
