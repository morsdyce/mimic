...
class MockedRequests extends React.Component {
  ...
  componentDidMount() {
    this.props.API.on(EVENTS.UPDATE_MOCK, this.reRender);
    this.props.API.on(EVENTS.UPDATE_GROUP, this.reRender);
  }

  componentWillUnmount() {
    this.props.API.off(EVENTS.UPDATE_MOCK, this.reRender);
    this.props.API.off(EVENTS.UPDATE_GROUP, this.reRender);
  }
