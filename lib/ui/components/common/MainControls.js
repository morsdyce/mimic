...
export const MainControls = ({ closeFullEditor, sizeFullEditor, fullEditorSize }) => (
  <MainActions>
    ...
    <button disabled={fullEditorSize === 'half'}>
      <Icon src={halfScreenIcon} alt="Half Screen" onClick={() => sizeFullEditor('half')}/>
    </button>
    <button disabled={fullEditorSize === 'full'}>
      <Icon src={fullScreenIcon} alt="Full Screen" onClick={() => sizeFullEditor('full')}/>
    </button>
    <button>
