    ...
    return this.props.connectDropTarget(
      <div style={{ position: 'relative', height: '100%' }}>
        ...
        <SidebarContainer
          ...
          <ActionsContainer>
            <ActionGroup>
              <Action src="add" onClick={ this.addNewMock }/>
              <Action src="record" onClick={ this.toggleRecording }/>
            </ActionGroup>

            <ActionGroup autosize>
              <Action src="collapseAll" onClick={ MockState.collapseAllGroups }/>
              <Action src="expandAll" onClick={ MockState.expandAllGroups }/>
            </ActionGroup>

            <ActionGroup>
              <Action src="undo"/>
              <Action src="remove" onClick={ MockState.deleteSelected }/>
            </ActionGroup>
          </ActionsContainer>
          { this.getGroups() }
          { this.getMocks() }
