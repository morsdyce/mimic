...
class RequestLog extends React.Component {
  ...
  export = () => {
    ...
    const blob = new Blob([API.export(UIState.prettifyExport)], { type: 'application/json' });
    link.download = `${UIState.exportFilename.replace(/\.json$/, '')}.json`;
      ...
      <Frame>
        <Container>
          ...
          <Section>
            ...
            <BlueButton onClick={ this.export }>Download as file</BlueButton>
