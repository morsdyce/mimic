  ...
  render() {
    ...
    return (
      <MenuWrapper style={{ top: UIState.mocksSidebarMenu.y, left: UIState.mocksSidebarMenu.x }}
        ...
        <MenuItem disabled={ UIState.selectedItems.length < 1 } onClick={ this.cut }>
          Cut
        </MenuItem>

        <MenuItem disabled={ UIState.selectedItems.length < 1 } onClick={ this.copy }>
          Copy
        </MenuItem>

        <MenuItem disabled={ this.canPaste() } onClick={ this.paste }>
          Paste
        </MenuItem>
        ...
        <MenuItem disabled={ UIState.selectedItems.length > 1 } onClick={ this.findRelated }>
