...
const RequestNavigationSection = styled(Section)`
  cursor: pointer;
...
class QuickEdit extends React.Component {
  ...
  render() {
    ...
    return (
      <Container>
        <RequestNavigationSection disabled={ this.isFirstCapturedRequest } onClick={ this.selectPreviousRequest }>
          <Icon src={ leftIcon } disabled={ this.isFirstCapturedRequest } alt="Previous Request"/>
        </RequestNavigationSection>

        <RequestNavigationSection disabled={ this.isLastCapturedRequest } onClick={ this.selectNextRequest }>
          <Icon src={ rightIcon } disabled={ this.isLastCapturedRequest } alt="Next Request"/>
        </RequestNavigationSection>
        ...
        <Section>
          <Icon src={ stopwatchIcon } alt="Response Delay"/>
          <Select
