...
class Editor extends React.Component {
  ...
  updateMockedRequest(partialUpdate) {
    ...
    API.updateMockedRequest(selectedMock.id, mock)
  }
  ...
  render() {
    ...
    if (this.state.selectedTab === 'response' && this.state.selectedResponseContentTab === 'body') {
      value = selectedMock.response.body;
    } else if (this.state.selectedTab === 'response' && this.state.selectedResponseContentTab === 'headers') {
      value = selectedMock.response.headers;
    }
