...
import { fetchScenarios, toggleScenario, duplicateScenario } from 'ui/actions/api';
...
export default connect(mapStateToProps, { fetchScenarios, toggleScenario, duplicateScenario })(Scenarios);
