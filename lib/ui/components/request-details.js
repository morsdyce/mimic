...
class RequestDetails extends Component {
  ...
  _handleSave() {
    const selectedScenario = this.state.selectedScenario.hasOwnProperty('value') ? this.state.selectedScenario.value : this.state.selectedScenario;
    if (this.props.mock && selectedScenario === this.state.originalScenario) {
      this.props.updateMock(selectedScenario, this.props.mock.id, {
        url: this.state.url,
      ...
      this.props.mockRequest(selectedScenario, {
