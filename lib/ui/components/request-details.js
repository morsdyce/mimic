...
class RequestDetails extends Component {
  ...
  _handleSave() {
    if (this.props.mock && this.state.selectedScenario.value === this.state.originalScenario) {
      this.props.updateMock(this.state.selectedScenario.value, this.props.mock.id, {
        url: this.state.url,
      ...
      this.props.mockRequest(this.state.selectedScenario.value, {
