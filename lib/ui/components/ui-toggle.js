...
import { saveTogglePosition, getTogglePosition } from 'ui/utils/storage';
...
export class UIToggle extends React.Component {
  ...
  componentWillMount() {
    this._setPosition(getTogglePosition());
  }
