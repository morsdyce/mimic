...
import { Divider, List, ListItem, Toggle, IconButton, RaisedButton } from 'material-ui';
      ...
      return (
        <div key={ mockedRequest.id } className="row">
          ...
          <div className="col-xs-3 end-xs middle-xs">
            ...
            <InlineExport filename={ mockedRequest.url } exportData={ () => API.exportMock(this.props.id, mockedRequest.id) } />
          </div>
