...
export class Scenario extends React.Component {
  ...
  static get propTypes() {
    return {
      ...
      renameScenario: React.PropTypes.func.isRequired,
  ...
  _renameScenario() {
    ...
    this.props.renameScenario(this.props.id, newName);
  }

  _removeScenario() {
    this.props.removeScenario(this.props.id);
  }

  _duplicateScenario() {
    this.props.duplicateScenario(this.props.id);
  }
