...
function initFrame() {
  ...
  style.innerHTML += normalizeCss.toString();
  style.innerHTML += flexboxGrid.toString();
  style.innerHTML += robotoFontFace.toString();
  style.innerHTML += reactSelect.toString();
  style.innerHTML += applicationCss.toString();
...
function sendMessage(message) {
  console.log(message);
  appFrame.contentWindow.postMessage(message, window.location.origin);
}
