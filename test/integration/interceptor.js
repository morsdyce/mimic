module.exports = {
  ...
  'Get Fetch mocked' : function (browser) {
    browser
      ...
      .execute(function(data) {
        window.mimic.api.import('{"version":"1.0.2","mocks":[{"id":"1e4cef8d-5724-4e9b-812c-4ed260107194","active":true,"method":"GET","url":"http://mimic-example.com/get","headers":{"pragma":"no-cache","content-type":"text/plain; charset=utf-8","cache-control":"no-cache","expires":-1},"params":"","response":{"delay":20,"status":200,"body":"GET-FETCH"}}]}');
      })
      .waitForElementVisible('#get-fetch', 1000)
      .click('#get-fetch')
      .pause(500)
  ...
  'GET Fetch Wildcard mocked' : function (browser) {
    browser
      .url('http://127.0.0.1:8080/integration-tests')
      .execute(function(data) {
        window.mimic.api.import('{"version":"1.0.2","mocks":[{"id":"5f3e7faa-64ea-40c8-9002-4d596c396c43","active":true,"method":"GET","url":"http://mimic-example.com/get-wildcard/*","headers":{"pragma":"no-cache","content-type":"text/plain; charset=utf-8","cache-control":"no-cache","expires":-1},"params":"","response":{"delay":19,"status":200,"body":"GET-WILDCARD"}}]}');
      })
      .waitForElementVisible('#get-fetch-wildcard', 1000)
      .click('#get-fetch-wildcard')
      .pause(500)
  ...
  'GET Fetch Url Wildcards + Request param wildcards mocked' : function (browser) {
    browser
      .url('http://127.0.0.1:8080/integration-tests')
      .execute(function(data) {
        window.mimic.api.import('{"version":"1.0.2","mocks":[{"id":"ed974e36-cdb5-4987-9390-7acc7d342a24","active":true,"method":"GET","url":"http://mimic-example.com/get-delay","headers":{"pragma":"no-cache","content-type":"text/plain; charset=utf-8","cache-control":"no-cache","expires":-1},"params":"","response":{"delay":"2000","status":200,"body":"GET-DELAY"}}]}');
      })
      .waitForElementVisible('#get-fetch-delay', 1000)
      .click('#get-fetch-delay')
      .pause(50)
  ...
  'GET Fetch Worker' : function (browser) {
    browser
      .url('http://127.0.0.1:8080/integration-tests')
      .execute(function(data) {
        window.mimic.api.import('{"version":"1.0.2","mocks":[{"id":"e218a790-5c9b-47f2-87da-184b949a9ed4","active":true,"method":"GET","url":"http://mimic-example.com/worker","headers":{"pragma":"no-cache","content-type":"text/plain; charset=utf-8","cache-control":"no-cache","expires":-1},"response":{"delay":25,"status":200,"body":"FETCH-WORKER"}}]}');
      })
      .waitForElementVisible('#webworker-get-fetch', 1000)
      .click('#webworker-get-fetch')
      .pause(1000)
