      ...
      "mockedRequests": [
        {
          ...
          "active": true,
          "method": "GET",
          "url": "http://500tech.github.io/bdsm/api/content",
          "headers": {
            "pragma": "no-cache",
        ...
        },
        {
          ...
          "active": true,
          "method": "GET",
          "url": "http://500tech.github.io/bdsm/api/*/json",
          "headers": {
            "pragma": "no-cache",
          ...
          "response": {
            ...
            "body": {
              ...
              "repository": {
                "type": "git",
                "url": "https://github.com/500tech/bdsm.git"
              },
        ...
        },
        {
          ...
          "active": true,
          "method": "POST",
          "url": "http://500tech.github.io/bdsm/api/body-wildcards",
          "headers": {
            "pragma": "no-cache",
            "content-type": "application/json; charset=utf-8",
            "cache-control": "no-cache",
...
if (screen.width > 1024) {
  $.holdReady(true);
  $.getScript("https://npmcdn.com/bdsm@1.0.2/dist/bdsm.js", function() {
    $.holdReady(false);
  });
}
